...
public class SettingsActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        ((TextView) findViewById(C0785R.C0788id.RemainingDaysText)).setText(((Object) getResources().getText(C0785R.string.remaining_time)) + Deobfuscator$app$Release.getString(-13033211229988L) + XXX());
    }
                ...
                new Thread(new Runnable() { // from class: com.easyvictory.cheto.SettingsActivity.1
                    ...
                    public void run() {
                        ...
                        if (XXXX.length() > 0) {
                            ...
                            if (XXXX.equals(Deobfuscator$app$Release.getString(-12981671622436L))) {
                                ((TextView) SettingsActivity.this.findViewById(C0785R.C0788id.RemainingDaysText)).setText(((Object) SettingsActivity.this.getResources().getText(C0785R.string.remaining_time)) + Deobfuscator$app$Release.getString(-13016031360804L) + SettingsActivity.this.XXX());
                            }
                        }
                    }
                }).start();
